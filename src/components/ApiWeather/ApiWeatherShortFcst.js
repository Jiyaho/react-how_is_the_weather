...
function ApiWeatherShortFcst() {
  const [weathers, setWeathers] = useState([]);
  const [error, setError] = useState(null);
  // const 초단기실황 = "getUltraSrtNcst";
  // const 단기예보 = "getVilageFcst";
  const ApiName = "getUltraSrtFcst"; //초단기예보: baseTime부터 6시간 예보
  ...
  const numOfRows = "60"; //시간당 측정 obj데이터 10개 * 최대 6시간 예보 = 60
...
export default ApiWeatherShortFcst;
